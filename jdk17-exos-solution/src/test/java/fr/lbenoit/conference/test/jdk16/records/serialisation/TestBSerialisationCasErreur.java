package fr.lbenoit.conference.test.jdk16.records.serialisation;
...
public class TestBSerialisationCasErreur {
	...
	public void Deserialiser() throws Exception {
		try (FileInputStream fis = new FileInputStream("target/position2.serial");
